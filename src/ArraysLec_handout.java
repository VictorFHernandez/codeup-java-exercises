...
//        System.out.println("sidesArray[6] = " + sidesArray[6]);  doesn't work
        ...
        String[] Tekken = {"kazuya","jin","king","law"};
        System.out.println("my favorite character in tekken is " + Tekken[0]);
        ...
        for(int i = 0; i < cohorts.length; i++){
            System.out.println("Codeup has a number of cohorts! One of them is the " + cohorts[i]);
        }
        ...
        String[] food = {"pizza", "tacos", "gyros"};

        for(String foods : food){
            System.out.println("i want some " + foods);
        }
